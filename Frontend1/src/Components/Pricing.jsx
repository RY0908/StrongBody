        ...
        <div className="flex flex-col justify-center items-center text-white text-center bg-backroundPricingCard bg-cover rounded-xl mx-auto min-w-fit  ease-in-out duration-300 delay-100 hover:p-5    ">
          ...
          >
            <path
              fill="#F3F4F6 "
              fill-opacity="1"
              d="M0,96L34.3,112C68.6,128,137,160,206,154.7C274.3,149,343,107,411,112C480,117,549,171,617,165.3C685.7,160,754,96,823,64C891.4,32,960,32,1029,69.3C1097.1,107,1166,181,1234,202.7C1302.9,224,1371,192,1406,176L1440,160L1440,320L1405.7,320C1371.4,320,1303,320,1234,320C1165.7,320,1097,320,1029,320C960,320,891,320,823,320C754.3,320,686,320,617,320C548.6,320,480,320,411,320C342.9,320,274,320,206,320C137.1,320,69,320,34,320L0,320Z"
            ></path>
          </svg>
